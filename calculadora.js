...
function modoEscuro(){
    if(document.querySelector(".dark").innerHTML == "💡 Dark"){
        ...
        document.querySelector(".calculadora").style.backgroundImage = "URL('./imagens/gokussj.jpeg')"
        ...
        document.querySelector(".calculadora").style.transition = "2s"
        document.querySelector(".calculadora").style.backgroundImage = "URL('./imagens/goku.webp')"
